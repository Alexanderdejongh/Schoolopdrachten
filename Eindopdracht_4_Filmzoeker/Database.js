...
// function elementByIdFunction(element, func) {
//     const id = document.getElementById(element);
//     id.addEventListener("click", func);
// }

// functie die content geeft voor de innerHTML

// functies die in de HTML toevoegen
...
const clickNewFilm = newFilm.addEventListener("click", () => {
    // console.log(niewsteFilms);
    document.querySelector(".filmsContainer").innerHTML = `
